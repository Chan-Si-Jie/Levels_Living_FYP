...
const HQDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const deliveryRes = await axios.get("http://localhost:5000/api/deliveries");// replace with your service URL
        const driverRes = await axios.get("http://localhost:5000/api/drivers");// replace with your service URL
